...
/* Delete item */
const deleteItem = () => {
  countriesStore.deleteItem(currentId.value)
}

const items = computed(() => countriesStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/countries/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"

module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('promo_codes', 'discount', {
        transaction,
      });

      await queryInterface.removeColumn('promo_codes', 'code', { transaction });
      ...
      await queryInterface.removeColumn('reviews', 'body', { transaction });

      await queryInterface.removeColumn('orders', 'status', { transaction });

      await queryInterface.removeColumn('orders', 'amount', { transaction });
      ...
      await queryInterface.removeColumn('orders', 'orderDate', { transaction });
      ...
      await queryInterface.removeColumn('products', 'rating', { transaction });
      ...
      await queryInterface.removeColumn('products', 'title', { transaction });
      ...
      await queryInterface.dropTable('promo_codes', { transaction });
